...
public class CustomerController {
    ...
    // Dashboard with simple search by name/category
    ...
    public String addToCart(@RequestParam("medicineId") int medicineId,
        ...
        try {
            ...
            System.err.println("Add to cart failed. customerId=" + customerId + ", medicineId=" + medicineId + ", quantity=" + quantity);
            e.printStackTrace();
